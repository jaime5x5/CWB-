...
/**
 * Output alternative footer copyright notice. Custom markup with PHP dynamic date
 *
 * @return void directly echos the footer copyright notice HTML markup
 **/
if( ! function_exists( 'avada_render_footer_copyright_notice_alt' ) ) {
    function avada_render_footer_copyright_notice_alt() {
        global $smof_data;
 
        echo '<div class="fusion-copyright-notice">';
            echo 'Copyright ' . date('Y') . ' | All Rights Reserved | Created by <a href="#"_blank">Williams Web Solutions</a> | <a href="terms-conditions">Terms & Conditions</a> | <a href="policies">Policies</a>';
        echo '</div>';
    }
}
add_action( 'avada_footer_copyright_content', 'avada_render_footer_copyright_notice_alt', 10 );
